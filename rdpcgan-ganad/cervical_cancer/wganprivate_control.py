        ...
        for i_batch, samples in enumerate(dataloader_train):
            ...
            if opt.dp_privacy:
                ...
                for i in range(opt.batch_size):
                    ...
                    fake_unsqueezed = fake.unsqueeze(dim=2)
                    # print(fake_unsqueezed.size())
                    fake_unsqueezed_decoded = autoencoderDecoder(fake_unsqueezed)
                    fake_decoded = torch.squeeze(fake_unsqueezed_decoded, dim=1)
