    ...
    for e in [0.1, 1, 10]:
        ...
        for n in range(1, number_of_tests + 1):
            ...
            os.system(
                ...
                f"--classLabel 0.0 --n_epochs {main_epochs} --noise_multiplier {noise_mult} --AD_budget {ad_epsilon}")

            os.system(
                f"venv_directory/python wganprivate_pregen.py "
                f"--classLabel 1.0 --n_epochs {main_epochs} --noise_multiplier {noise_mult} --AD_budget {ad_epsilon}")
