...
def dp_gan_main(args):
    ...
    anomaly_detector = DP_Autoencoder(data.shape[1], int(data.shape[1] / 2), epsilon=float('inf'))
    ...
    for class_label in [0, 1]:
        ...
        train_class = clean_train_data[clean_train_data[:, -1] == class_label]
