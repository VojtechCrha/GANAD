...
def pategan_main(args):
    ...
    print("Loaded datasets, training autoencoder")
    ...
    parameters = {'n_s': args.n_s, 'batch_size': args.batch_size, 'k': args.k,
                  ...
                  'lamda': args.lamda, 'ad_budget' : args.ad_budget}
    ...
    ad_budget = args.ad_budget * args.epsilon
    anomaly_detector = DP_Autoencoder(data.shape[1], int(data.shape[1] / 2), epsilon= ad_budget)
    ...
    for model_index in range(len(models)):
        ...
        synth_train_indices = anomaly_detector.get_top_anomalies(synth_train_data, num_anomalies=10)
        clean_synth_train_data = np.delete(synth_train_data, synth_train_indices, axis=0)
    ...
    return results, synth_train_data
