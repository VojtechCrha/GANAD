...
from mid_gen_AD_pategan import pategan_main
import argparse
...
def final_testing():
    for e in [0.1, 1, 10]:
        ...
        folder_name = f"results/mid_gen_eps={args.epsilon}_dataset={args.dataset}_iters={args.iterations}_k={args.k}_ad_budget={args.ad_budget}_delta={args.delta}_ns={args.n_s}_lambda={args.lamda}_noise_rate={args.noise_rate}_batchsize={args.batch_size}"
